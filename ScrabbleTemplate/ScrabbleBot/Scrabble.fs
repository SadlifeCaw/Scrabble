...
module State = 
    ...
    let mkState b pob d pn pt np h pp = {board = b
                                         piecesOnBoard = pob
                                         dict = d
                                         playerNumber = pn
                                         playerTurn = pt
...
module Scrabble =
    ...
    let playGame cstream pieces (st : State.state) =
        ...
        let rec aux (st : State.state) =
            ...
            | RCM (CMPlayed (pid, ms, points)) ->
                ...
                let st' = State.mkState st.board newBoard st.dict newPlayer st.playerNumber st.numPlayers st.hand newPoints
    ...
    let startGame 
        ...
        fun () -> playGame cstream tiles (State.mkState board Map.empty dict playerNumber playerTurn numPlayers handSet Map.empty)
