...
module State = 
    ...
    let findWord st =
        ...
        then findWordFromCoord st (0,0) Right st.dict st.hand [] []
        else
...
module Scrabble =
    ...
    let startGame 
        ...
        fun () -> playGame cstream tiles (State.mkState board Map.empty dict playerNumber playerTurn numPlayers handSet Map.empty Map.empty)
